  ...
  return (
    ...
    >
      <div
        ...
        className={cn(
          "absolute inset-4 grid h-[calc(100%-2rem)] w-[calc(100%-2rem)] grid-rows-[1fr_auto] rounded-xl shadow-lg",
          innerInsetClassName
        )}
      >
        <div className="absolute inset-0 flex items-center justify-center rounded-xl bg-transparent">
          <img
            src={imageUrl}
            alt={`${title}, ${subtitle}`}
            className={cn(
              ...
              <div className="flex items-start justify-between gap-4">
                <div>
                  ...
                  <motion.p
                    ...
                    className="mt-1 text-sm font-light text-white/80"
                  >
                    {subtitle}
                  </motion.p>
                </div>
